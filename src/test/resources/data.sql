...
VALUES
    ...
    ('AIA', 'Anguilla', 'North America', 'Caribbean', 96, 0, 8000, 76.1, 63.2, 0, 'Anguilla', 'Dependent Territory of the UK', 'Elisabeth II', 62, 'AI'),
    ('ALB', 'Albania', 'Europe', 'Southern Europe', 28748, 1912, 3401200, 71.6, 3205, 2500, 'Shqipëria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
    ('AND', 'Andorra', 'Europe', 'Southern Europe', 468, 1278, 78000, 83.5, 1630, 0, 'Andorra', 'Parliamentary Coprincipality', NULL, 55, 'AD'),
    ...
    ('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 13120000, 0, 0, 0, 0, 0, '–', 'Co-administrated', NULL, 0, 'AQ'),
    ...
    ('FSM', 'Micronesia, Federated States of', 'Oceania', 'Micronesia', 702, 1990, 119000, 68.6, 212, 0, 'Micronesia', 'Federal Republic', 'Leo A. Falcam', 2689, 'FM'),
    ...
    ('KIR', 'Kiribati', 'Oceania', 'Micronesia', 726, 1979, 83000, 59.8, 40.7, 0, 'Kiribati', 'Republic', 'Teburoro Tito', 2256, 'KI'),
    ...
    ('MCO', 'Monaco', 'Europe', 'Western Europe', 1.5, 1861, 34000, 78.8, 776, 0, 'Monaco', 'Constitutional Monarchy', 'Rainier III', 2695, 'MC'),
    ...
    ('SMR', 'San Marino', 'Europe', 'Southern Europe', 61, 885, 27000, 81.1, 510, 0, 'San Marino', 'Republic', NULL, 3171, 'SM'),
    ...
    ('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0.4, 1929, 1000, 0, 9, 0, 'Santa Sede/Città del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
    ...
    ('VGB', 'Virgin Islands, British', 'North America', 'Caribbean', 151, 0, 21000, 75.4, 612, 573, 'British Virgin Islands', 'Dependent Territory of the UK', 'Elisabeth II', 537, 'VG'),
    ('VIR', 'Virgin Islands, U.S.', 'North America', 'Caribbean', 347, 0, 93000, 78.1, 0, 0, 'Virgin Islands of the United States', 'US Territory', 'George W. Bush', 4067, 'VI'),
